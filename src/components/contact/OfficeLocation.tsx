...
const OfficeLocation = ({ isVisible }: OfficeLocationProps) => {
    ...
    <div className={`bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 ${
      ...
      <div className="space-y-4 mb-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <p className="text-white font-semibold">WeWork Prestige Central</p>
            <p className="text-slate-300">36, 1, Church St, opposite to Cubbon Park</p>
            <p className="text-slate-300">Shanthala Nagar, Ashok Nagar</p>
            <p className="text-slate-300">Bengaluru, Karnataka 560001</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-slate-300">info@skillupinterns.com</p>
          </div>
        </div>
